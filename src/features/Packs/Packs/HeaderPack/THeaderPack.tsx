...
interface EnhancedTableProps {
  onRequestSort: (event: React.MouseEvent<unknown>, property: keyof PacksRow) => void;
  order: Order;
  orderBy: string;
}
...
export const THeaderPack: FC<EnhancedTableProps> = (props) => {
  ...
  const createSortHandler = (property: keyof PacksRow) => (event: React.MouseEvent<unknown>) => {
